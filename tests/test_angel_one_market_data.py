...
from integrations.angel_one_market_data import AngelOneMarketData, AngelInstrument
...
def test_fno_quotes_maps_nearest_future_to_underlying(monkeypatch):
    ...
    instruments = {
        ("NFO", "INDIGO25SEP26FUT"): AngelInstrument("INDIGO25SEP26FUT", "1", "NFO", "25SEP2026", "FUTIDX"),
    }
    ...
    monkeypatch.setattr(client, "full_quotes", lambda symbols, exchange="NFO": {
        "INDIGO25SEP26FUT": {"ltp": 5000, "oi": 100000, "change_pct": 1.2, "source": "angel"}
    })
