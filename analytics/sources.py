...
def public_source_inventory() -> list[dict[str, Any]]:
    ...
    return [
        ...
        {"source": "NSE FII/DII activity", "coverage": "cash-market activity", "cadence": "scanner cache refresh", "status": "ACTIVE"},
        {"source": "NSE corporate announcements", "coverage": "event-volatility labels", "cadence": "scanner refresh and manual", "status": "ACTIVE"},
